		...
		<div class="cfg-contactform-content">
			...
			<div id='reg1'>
			 <center>
				...
				<br><br><br>
				<input type='button' value='Home' style='width:200px;'onclick='location.replace("http://192.168.16.9:8888/Delegate/Delegate-Rating/business-calendarbuyerconfirm.php")'/>
			</center>
			</div>
<br><br><br><br><br>
		</div>
