		...
		?>
					<?php
						...
						<?php	
													...
													{
						?>							
														<input type='button' class='btn btn-default' style='width: 250px;' value='Requests This Seller' onClick="location.replace('query/tempRequestSellerList.php?id=<?php echo $_GET['id']; ?>');">
												<!-- Viroj 6-July-15
														<input type='button' class='btn btn-default' style='width:250px;' value='Appoinment Requests 2' onClick="location.replace('appointmentRequestSellerList.php');">
												-->
						<?php
													}
												}
...
?>
		<div class="form-group">
			...
			<div class="col-md-11">
			<?php
				$qryn=mysql_query("select fullname,email from mas_buyer inner join buyer_delegate_detail on mas_buyer.mas_buyer_id = buyer_delegate_detail.mas_buyer_id and username = '".$_SESSION['user_name']."' and buyer_delegate_detail.buyer_delegate_status = 'Y' and mas_buyer.mas_buyer_status = 'Y'");
		...
		<div class="form-group">
			<div class="col-md-12">
				<h5 style="margin-left:-10px;">Dear&nbsp;<?php echo $sellercomdear;?>,<br><br>May I request to meet you at <b>PTM <?php echo $ptm_year;?> <?php echo $slotDescemail."?"; ?></b><br><br><b>Please accept and confirm my appointment request by replying to this email directly.</b></h5>
