...
<title>Confirm&nbsp;Appointment&nbsp;Request&nbsp;Buyer</title>
...
if(isset($_SESSION['mas_user_name']) && $_SESSION['mas_user_name'] == 'Y')
{
	echo "<ul class='nav navbar-nav side-nav'>";
		...
		echo "<li class='active'><a href='confirmAppointmentRequestBuyer.php'><i class='fa fa-briefcase'></i>&nbsp;Confirm Appointment Requests</a></li>";
/*
...
<?php
	...
	if(mysql_num_rows($tq) > 0 && $rs=mysql_fetch_array($tq))
	{
		...
		View Appointment Requests</a></li>";
			...
			{
				echo "<li class='active'><a href='advanceBuyerList.php'><i class='fa fa-briefcase'></i>
		View Appointment Requests</a></li>";
			}
		}
	}
...
<script src="http://cdn.oesmith.co.uk/morris-0.4.3.min.js"></script> <script
	...
	{
		ajaxfunction("query/confirmAppointmentRequestSeller.php", "document.getElementById('ajaxResult').innerHTML = ajaxRequest.responseText;");
	}
