...
<title>Advance&nbsp;New&nbsp;Buyer&nbsp;List</title>
...
if(isset($_SESSION['mas_user_name']) && $_SESSION['mas_user_name'] == 'Y')
{
	echo "<ul class='nav navbar-nav side-nav'>";
		...
		echo "<li><a href='business-calendarsellerconfirm.php'><i class='fa fa-book'></i>&nbsp;Business Calendar</a></li>
			...
			<li class='active'><a href='advanceNewBuyerList.php'>New Registrations</a></li>
			</ul>
			</li>";
			...
			if($allon == 'Y')
			{
						echo "<li><a href='business-calendarsellerconfirm.php'><i class='fa fa-book'></i>&nbsp;Business Calendar</a></li>
								...
								<li class='dropdown open'><a href='#' class='dropdown-toggle' style='background-color: #056495;'
									...
									<ul class='dropdown-menu'>
											<li><a href='advanceBuyerCancellationList.php'>Cancellations</a></li>
											<li class='active'><a href='advanceNewBuyerList.php' style='color: rgb(255, 255, 255);background-color: #1b5485;'>New Registrations</a></li>
									</ul>
								</li>";
			}
			else
...
<table	class="table table-bordered table-hover table-striped tablesorter">
	...
	<tbody>
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type='button' class='btn btn-default' style='width:250px;' id='searchBut' value='Search' onclick="advanceBuyerList('4');">
				...
				<div class="panel-body">
					<div class="panel-body">
						...
						<?php
							...
							echo "<a href='#' onClick=\"$('#svalue').val('regexp \'^[0-9]\'');$('#index').html('0-9');advanceBuyerList('4');\">0-9</a>&nbsp;&nbsp;|&nbsp;&nbsp;";
							for($i=65;$i<=90;$i++)
							{
								echo "<a href='#' onClick=\"$('#svalue').val('like \'".chr($i)."%\'');$('#index').html('".chr($i)."');advanceBuyerList('4');\">".chr($i)."</a>&nbsp;&nbsp;|&nbsp;&nbsp;";
							}
							echo "<a href='#' onClick=\"$('#svalue').val('like \'%\'');$('#index').html('A-Z');advanceBuyerList('4');\">ALL</a>&nbsp;&nbsp;</span>";
