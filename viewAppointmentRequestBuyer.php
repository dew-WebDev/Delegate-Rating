...
<title>View&nbsp;Appointment&nbsp;Request&nbsp;Buyer&nbsp;List</title>
...
?>
					<form class="form-signin" action="query/insertMultipleBuyerRequest.php" id="requestForm" method="post" accept-charset="utf-8" enctype="multipart/form-data">
						...
						<span>
							...
							<center>
								<input type='button' class='btn btn-default' style='width:250px;' id='butsave' value='Return to Advance Buyer List' onClick="location.replace('advanceBuyerList.php');" />
								<input type='button' class='btn btn-default' style='width:250px;' id='butsave' value='Save' onClick="$('#hidmode').val('1'); $('#requestForm').submit();" />
								<input type='button' class='btn btn-default' style='width:250px;' id='butsubmit' value='Submit' onClick="$('#hidmode').val('2'); $('#requestForm').submit();" disabled />
							</center>
						</span>
					</form>
					</div>
...
<script lang="javascript">
	...
	{
		ajaxfunction("query/viewAppointmentRequestBuyer.php", "ajax(ajaxRequest.responseText,'5','#btype');");
	}
</script>
</body>
</html>