				...
				<div class="col-lg-12">
					...
					<div class="row">
						...
						<div class="col-lg-6" style="margin-top:30px;">
							<span style="font-size:16px; font-weight:Bold; font-family:Arial;">PATA Adventure Travel Mart <?php echo $ptm_year;?> <br>BUYER APPOINTMENT SCHEDULE <br><?php echo $bcname; ?>, <?php echo $bcountry; ?><br><?php echo $bname; ?> <br>Reg. No : <?php echo $bcomid; ?></span>
						</div>
						<div class="col-lg-2">
...
echo "Please note that it's compulsory for all buyers to fulfil 100% of the appointments on their business calendar (Total 30 appointments including any EMPTY slots) with ACTM2017 Sellers' signatures and participate on the Compulsory session of SELLER-MEET-BUYER OPEN HALL SESSION on Sep 8 during 0900-0945.";
