				...
				<div class="col-lg-12">
					...
					<div class="row">
						...
						<div class="col-lg-6" style="margin-top:30px;">
							<span style="font-size:16px; font-weight:Bold; font-family:Arial;">PATA Adventure Travel Mart <?php echo $ptm_year;?> <br>SELLER APPOINTMENT SCHEDULE <br><?php echo $scname; ?>, <?php echo $scountry; ?> <br><?php echo $sname; ?> <br>Reg. No : <?php echo $scomid; ?></span>
						</div>
						<div class="col-lg-2">
