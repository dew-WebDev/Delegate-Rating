...
<title>Advance&nbsp;Seller&nbsp;Cancellation&nbsp;List</title>
	...
	echo"<li><a href='business-calendarbuyerconfirm.php'><i class='fa fa-book'></i>&nbsp;Business Calendar</a></li>
		...
		List <b class='caret'></b><font class='sidebar-alt'>".$preadd_list."</font></a>
			<ul class='dropdown-menu'>
				<li class='active'><a href='advanceSellerCancellationList.php'>Cancellations</a></li>
...
<li class='dropdown open'><a href='#' style='background-color: #056495;'
		...
		List <b class='caret'></b><font class='sidebar-alt'>".$preadd_list."</font></a>
		<ul class='dropdown-menu'>
				<li class='active'><a href='advanceSellerCancellationList.php' style='color: rgb(255, 255, 255);background-color: #1b5485;'>Cancellations</a></li>
				<li><a href='advanceNewSellerList.php'>New Registrations</a></li>
		</ul>
	</li>";
	}
...
<h3 class="panel-title">SELLER CANCELLATIONS</h3>
</div>
	...
	<tbody>
		...
		<tr>
			...
			<td><input type='button' class='btn btn-default'
				...
				onclick="advanceSellerList('3');"> <input type='button'
...
<div id='sort'><?php
							...
							echo "<a href='#' onClick=\"$('#svalue').val('regexp \'^[0-9]\'');$('#index').html('0-9');advanceSellerList('3');\">0-9</a>&nbsp;&nbsp;|&nbsp;&nbsp;";
							for($i=65;$i<=90;$i++)
							{
								echo "<a href='#' onClick=\"$('#svalue').val('like \'".chr($i)."%\'');$('#index').html('".chr($i)."');advanceSellerList('3');\">".chr($i)."</a>&nbsp;&nbsp;|&nbsp;&nbsp;";
							}
							echo "<a href='#' onClick=\"$('#svalue').val('like \'%\'');$('#index').html('A-Z');advanceSellerList('3');\">ALL</a>&nbsp;&nbsp;</span>";
