...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F80041939872462" title="oEmbed Form"><link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F80041939872462" title="oEmbed Form">
<meta property="og:title" content="Adventure-event survey - SELLER" >
<meta property="og:url" content="http://www.jotform.me/form/80041939872462" >
<meta property="og:description" content="Please click the link to complete this form.">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
<meta name="HandheldFriendly" content="true" />
<title>Checkform - Adventure SELLER</title>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.3959" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.3959" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.3959" />
...
<script type="text/javascript">
   JotForm.setConditions([{"action":[{"field":"21","visibility":"Show","id":"action_0_1515480354892","isError":false}],"id":"1422326854655","index":"3","link":"Any","priority":"3","terms":[{"field":"20","operator":"equals","value":"No","id":"term_0_1515480354892","isError":false}],"type":"field"}]);
   JotForm.init(function(){
      JotForm.highlightInputs = false;
    /*INIT-END*/
});

   JotForm.prepareCalculationsOnTheFly([null,null,{"name":"save","qid":"2","text":"Save","type":"control_button"},null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"clickTo16","qid":"16","text":"Post-event survey -&nbsp;SELLER","type":"control_text"},{"name":"1To","qid":"17","text":"1. To what degree is this Buyer interested in your product?","type":"control_radio"},{"name":"2Would","qid":"18","text":"2. Would you consider this buyer a business prospect?","type":"control_radio"},null,{"name":"input20","qid":"20","text":"3.","type":"control_radio"},{"name":"typeA","qid":"21","text":"(Please specify)","type":"control_textbox"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,{"name":"save","qid":"2","text":"Save","type":"control_button"},null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"clickTo16","qid":"16","text":"Post-event survey -&nbsp;SELLER","type":"control_text"},{"name":"1To","qid":"17","text":"1. To what degree is this Buyer interested in your product?","type":"control_radio"},{"name":"2Would","qid":"18","text":"2. Would you consider this buyer a business prospect?","type":"control_radio"},null,{"name":"input20","qid":"20","text":"3.","type":"control_radio"},{"name":"typeA","qid":"21","text":"(Please specify)","type":"control_textbox"}]);}, 20); 
</script>
</head>
<body>
<?php
...
?>
 ...
 <form class="jotform-form" action="update_seller_answer1b.php" method="post" name="form_80041939872462" id="80041939872462" accept-charset="utf-8">
        ...
        <div id="cid_17" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="3" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_17_0" name="q17_1To" value="Slightly" <?php if($answer1!= "") echo "checked"; ?> required="" />
            ...
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_17_2" name="q17_1To" value="Extremely" <?php if($answer3!= "") echo "checked"; ?> required="" />
        ...
        <div id="cid_18" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="3" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_18_0" name="q18_2Would" value="Yes" <?php if($answer4!= "") echo "checked"; ?> required="" />
              <label id="label_input_18_0" for="input_18_0"> <?php echo $storeArray[5]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_18_1" name="q18_2Would" value="No" <?php if($answer5!= "") echo "checked"; ?> required="" />
              <label id="label_input_18_1" for="input_18_1"> <?php echo $storeArray[6]; ?> </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1 jf-required" data-type="control_radio" id="id_20">
        <label class="form-label form-label-top" id="label_20" for="input_20">
          3. Should PATA invite and host this buyer to future travel trade shows?
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_20" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="2" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_20_0" name="q20_input20" value="Yes" <?php if($answer6!= "") echo "checked"; ?> required="" />
              <label id="label_input_20_0" for="input_20_0"> <?php echo $storeArray[8]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_20_1" name="q20_input20" value="No" <?php if($answer7!= "") echo "checked"; ?> required="" />
              <label id="label_input_20_1" for="input_20_1"> <?php echo $storeArray[9]; ?> </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-2 jf-required form-field-hidden" style="display:none;" data-type="control_textbox" id="id_21">
        ...
        <div id="cid_21" class="form-input-wide jf-required">
          <input type="text" id="input_21" name="q21_typeA" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="<?php echo "$answer7"; ?>" data-component="textbox" required="" />
        </div>
      </li>
        ...
        <div id="cid_2" class="form-input-wide">
          <div style="text-align:center;" class="form-buttons-wrapper">
            ...
            <span>
             ...
             <a href="business-calendarsellerconfirm.php" title="cancel" class="cancelbutton" style="text-decoration: none; padding:8px 18px;color: #777777;text-shadow:1px 1px 0px #ffffff;">Cancel</a>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="80041939872462" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "80041939872462-80041939872462";
  </script>
  ...
  <div class="form-all">
    <ul class="form-section page-section">
        ...
        <div id="cid_17" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="3" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_17_0" name="q17_1To" value="Slightly" required="" />
              <label id="label_input_17_0" for="input_17_0"> <?php echo $storeArray[1]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
            ...
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_17_2" name="q17_1To" value="Extremely" required="" />
              <label id="label_input_17_2" for="input_17_2"> <?php echo $storeArray[3]; ?> </label>
            </span>
          </div>
        </div>
        ...
        <div id="cid_18" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="3" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_18_0" name="q18_2Would" value="Yes" required="" />
              <label id="label_input_18_0" for="input_18_0"> <?php echo $storeArray[5]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_18_1" name="q18_2Would" value="No" required="" />
              <label id="label_input_18_1" for="input_18_1"> <?php echo $storeArray[6]; ?> </label>
            </span>
          </div>
        </div>
        ...
        <div id="cid_20" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="2" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_20_0" name="q20_input20" value="Yes" required="" />
              <label id="label_input_20_0" for="input_20_0"> <?php echo $storeArray[8]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_20_1" name="q20_input20" value="No" required="" />
              <label id="label_input_20_1" for="input_20_1"> <?php echo $storeArray[9]; ?> </label>
            </span>
          </div>
        </div>
      ...
      <li class="form-line form-line-column form-col-2 jf-required form-field-hidden" style="display:none;" data-type="control_textbox" id="id_21">
        ...
        <div id="cid_21" class="form-input-wide jf-required">
          <input type="text" id="input_21" name="q21_typeA" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" data-component="textbox" required="" />
        </div>
      </li>
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_button" id="id_2">
        <div id="cid_2" class="form-input-wide">
