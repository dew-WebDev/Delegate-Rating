...
<title>Reject&nbsp;Appointment&nbsp;Request&nbsp;Buyer</title>
...
if(isset($_SESSION['mas_user_name']) && $_SESSION['mas_user_name'] == 'Y')
{
	echo "<ul class='nav navbar-nav side-nav'>";
		...
		echo "<li class='active'><a href='rejectAppointmentRequestBuyer.php'><i class='fa fa-thumbs-o-down'></i>&nbsp;Rejection of unwanted appointment requests<br>
...
<?php
	if($_SESSION['chk'] == '3')
	{
		echo "<center><p style='font-size:16px;text-align:justify;'>&nbsp;&nbsp;Please view below appointment requests from buyers. If you do not want PATA to match any requests, please reject them. You are allowed to reject maximum 5 requests. Anyhow, there is no action required on this page if you do not want to reject any requests. To view your Business Calendar, please log in this system on ".$rejection_msg_date.".</p></center>";
	}
	else
	{
		echo "<center><p style='font-size:16px;text-align:justify;'>&nbsp;&nbsp;Please view below appointment requests from buyers. If you do not want PATA to match any requests, please reject them. You are allowed to reject maximum 10 requests. Anyhow, there is no action required on this page if you do not want to reject any requests. To view your Business Calendar, please log in this system on ".$rejection_msg_date.".</p></center>";
	}
?>
...
<script src="http://cdn.oesmith.co.uk/morris-0.4.3.min.js"></script> <script
	...
	{
		ajaxfunction("query/rejectAppointmentRequestSeller.php", "document.getElementById('ajaxResult').innerHTML = ajaxRequest.responseText;initTableSorter();");
	}
</script>
</body>
</html>