...
?>		
	<div class="cfg-contactform" id="cfg-contactform-1">
		<div class="cfg-contactform-content">
			...
			<div id='reg1'>
			 <center>
				<h1 style='color:#32464E'>Your Adventure Survey Fail To Submit For Further Information Please Contact Pata Administrators ...</h1>
				<br><br><br>
				<input type='button' value='Home' style='width:200px;'onclick='location.replace("http://192.168.16.9:8888/Delegate/Delegate-Rating/business-calendarsellerconfirm.php")'/>
			</center>
			</div>
<br><br><br><br><br>
		</div>
