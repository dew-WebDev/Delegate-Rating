...
$EMail_B="";
	...
	function sendmailAdmin($to,$id,$comid,$fullname, $position)
	{
		...
		$to1= SITE_EMAIL;
		$subject1 = "PTM2016".$ptm_year.": Thank you for your submission of online request (".$comid.")";
		$msg.="	
		<style>
		.title li
		{
...
Your PTM2016".$ptm_year." Business Calendar will be available on www.PATA.org/mart for you to view and download by August 17 (Monday).</p><br>
				Thank you.<br>
				PATA Events<br>
				Bangkok, Thailand
				</div>
