...
$txtemail="";
			...
			$qry=mysql_query("select * from mas_seller where mas_seller_id=".$msid);
			if(mysql_num_rows($qry)>0 && $rs=mysql_fetch_array($qry))
			{
				$txtemail=$rs['email'];
			}
	...
	function sendmailAdmin($to,$id,$comid,$fullname, $position, $org, $address, $CNT_ID, $msid)
	{
		...
		$to1= SITE_EMAIL; 
		$subject1 = "ACTM2017".$ptm_year.": Thank you for your submission of online request (".$comid.")";
		//echo $subject1;
		$msg.="	
		<style>
		.title li
...
Your ACTM2017".$ptm_year." Business Calendar will be available on www.PATA.org/mart for you to view and download by August 17 (Monday).</p><br>
				Thank you.<br>
				PATA Events<br>
				Bangkok, Thailand
				</div>
