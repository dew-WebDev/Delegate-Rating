...
session_start();
	try
	{
		if($_GET['mode'] == 1)
		{
			mysql_query("update delegate_requests set reject='N' where request_mode='S' and buyer_com_id=".$_SESSION['did']." and seller_com_id=".$_GET['id']);
		...
		{
			mysql_query("update delegate_requests set reject='N' where request_mode='B' and seller_com_id=".$_SESSION['did']." and buyer_com_id=".$_GET['id']);
