...
$this->setleftmargin(20);
	...
	if($this->PageNo() == 1) 
	{
		...
		$this->Cell(53);
		// Title
		$this->Cell(50,0,'PATA Adventure Travel Mart '.$ptm_year,0,0,'C');
		...
		$this->setXY(10,50);
		$this->Cell(50,0,"(Total 30 appointments including any EMPTY slots) with ACTM2017 Sellers' signatures and participate on the",0,0,'L');
		$this->setXY(10,55);
		$this->Cell(50,0,"Compulsory session of SELLER-MEET-BUYER OPEN HALL SESSION on Sep 8 during 0900-0945.",0,0,'L');
		$this->Ln(8);
	}
}
