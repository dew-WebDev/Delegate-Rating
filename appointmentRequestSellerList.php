...
<title>Appointment&nbsp;Request&nbsp;Seller&nbsp;List</title>
...
if(isset($_SESSION['mas_user_name']) && $_SESSION['mas_user_name'] == 'Y')
{
	...
	echo "<li class='active'><a href='viewAppointmentRequestSeller.php'><i class='fa fa-briefcase'></i>View Appointment Requests</a></li>";
	...
	<tbody>
		...
		<tr>
			...
			<td><input type='button' class='btn btn-default'
				...
				onclick="advanceSellerList('2');"> <input type='button'
...
<div id='sort'><?php
							...
							echo "<a href='#' onClick=\"$('#svalue').val('regexp \'^[0-9]\'');$('#index').html('0-9');advanceSellerList('1');\">0-9</a>&nbsp;&nbsp;|&nbsp;&nbsp;";
							for($i=65;$i<=90;$i++)
							{
								echo "<a href='#' onClick=\"$('#svalue').val('like \'".chr($i)."%\'');$('#index').html('".chr($i)."');advanceSellerList('2');\">".chr($i)."</a>&nbsp;&nbsp;|&nbsp;&nbsp;";
							}
							echo "<a href='#' onClick=\"$('#svalue').val('like \'%\'');$('#index').html('A-Z');advanceSellerList('2');\">ALL</a>&nbsp;&nbsp;</span>";
...
<center><input type='button' class='btn btn-default'
	style='width: 150px;' id='butsave' value='Save' onClick="location.replace('viewAppointmentRequestSeller.php');" /> <input type='button' class='btn btn-default'
	style='width: 250px;' id='butview' value='View My Appoinment Requests'
	onClick="location.replace('viewAppointmentRequestSeller.php');" /></center>
</span></div>
</div>
</div>
</div>
...
?>
<iframe style='display: none;' id='hidframe' name='hidframe'></iframe> <iframe
	style='display: none;' id='hidframe1' name='hidframe1'></iframe> <!-- /#page-wrapper -->
