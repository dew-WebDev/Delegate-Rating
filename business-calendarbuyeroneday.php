...
if(isset($_SESSION['mas_user_name']) && $_SESSION['mas_user_name'] == 'Y')
{
	...
	echo "<li class='active'><a href='business-calendarbuyeroneday.php'><i class='fa fa-home'></i>&nbsp;One&nbsp;Day&nbsp;Home</a></li>";
...
select 20 of your preferred Sellers from the Advance Seller List.
...
<p style="font-weight: normal; color: black;">&#42; The
Advance Seller List webpage lists all Sellers by organisations
alphabetically. You may use the advance search function to find<br>
...
To view the seller profile&#44; simply double click on the Seller
organisation name.</p>
...
request, simply tick on the request box on the right column next to the
country column.</p>
<p style="font-weight: normal; color: black;">&#42;&nbsp;You
are entitled to select up to 20 appointment requests.Please
remember to click on the &#39;save&#39; button every time you<br>
&nbsp;&nbsp;&nbsp;made some changes.</p>

<p style="font-weight: normal; color: black;">&#42;&nbsp;If
you do not want to request all 20 appointments at one time, you can
logout and revisit this site again later. All saved appointment<br>
&nbsp;&nbsp;&nbsp;requests will be intact.</p>

<p style="font-weight: normal; color: black;">
&#42;&nbsp;When you have completed making your 20
appointment requests, you may click on &#39;View Request&#39; button of
your Appointment<br>
...
matching process. (1 = first priority&#44; 20 = last priority)</p>
...
timeline (July 28 &#8211; 31)&#44; if you change your mind and would
