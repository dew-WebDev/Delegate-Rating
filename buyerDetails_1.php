...
$buyercomdear = $rsp['CompanyName'];
							...
							<table
								...
								<tbody>
									...
									<tr rowspan=3>
										<td colspan=2><p style='text-align:justify;width:100%;'><?php echo $rsp['d1']; ?></p></td>
									</tr>
									<tr>
									...
									<tr rowspan=3>
										<td colspan=2>
											...
											<?php
												...
												if($rsp['busitype1'] != "" )
												{
													$com.="<li>Outbound Group Travel</li>";
												}
												if($rsp['busitype2'] != "")
												{
													$com.="<li>Outbound Individual Travel</li>";
												}
												if($rsp['busitype3'] != "")
												{
													$com.="<li>Outbound Corporate / Business Travel</li>";
												}
												if($rsp['busitype4'] != "")
												{
													$com.="<li>Outbound Incentive Travel</li>";
												}
												if($rsp['busitype5'] != "")
												{
...
?>
		...
		<div class="form-group">
			<div class="col-md-12">
				<h5 style="margin-left:-10px;">Dear&nbsp;<?php echo $buyercomdear;?>,<br><br>May I request to meet you at <b>PTM <?php echo $ptm_year;?> <?php echo $slotDescemail; ?></b><br><br><b>Please confirm this appointment request by return email.</b></h5>
				<?php
...
?>
		...
		<div class="form-group">
			<div class="col-md-12">
				<h5 style="margin-left:-10px;">Dear&nbsp;<?php echo $buyercomdear;?>,<br><br>May I request to meet you at <b>PTM <?php echo $ptm_year;?> <?php echo $slotDescemail; ?></b><br><br><b>Please confirm this appointment request by return email.</b></h5>
				<?php
				$qryn=mysql_query("select fullname from mas_buyer inner join buyer_delegate_detail on mas_buyer.mas_buyer_id = buyer_delegate_detail.mas_buyer_id and mas_buyer.mas_buyer_com_id = ".$_GET['id']." and buyer_delegate_status = 'Y' and mas_buyer.mas_buyer_status = 'Y' and mas_buyer.fullname <> 'None.'");
