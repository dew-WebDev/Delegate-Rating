...
$this->setleftmargin(20);
	...
	if($this->PageNo() == 1) 
	{
		...
		// Title
		$this->setXY(70,10);
		$this->Cell(50,0,'PATA Adventure Travel And Responsible Tourism Conference And Mart '.$ptm_year,0,0,'L');
		...
		$this->setXY(10,50);
		$this->Cell(50,0,"(Total 20 appointments including any EMPTY slots) with ACTM2017 Sellers' signatures on Apr 23 during 0930-1650.",0,0,'L');
		$this->Ln(8);
	}
}
